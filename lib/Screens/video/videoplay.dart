...
class _VideoPlayState extends State<VideoPlay> {
  ...
  void initState() {
    ...
    link = widget.path;
    facebook =
        '<iframe src="https://www.facebook.com/plugins/post.php?href=$link"></iframe>';
    ...
    print(
        '<iframe src="https://www.facebook.com/plugins/post.php?href=$link&height=50" height="50" ></iframe>');
